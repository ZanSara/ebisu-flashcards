...
class Fact(mongo.Document):
    ...
    #     fact = fields.Str()
    #     renderer = fields.Nested(Renderer.RendererSchema)
    #     is_file = fields.Bool()
...
class Review(mongo.EmbeddedDocument):
    ...
    #     # type_schemas = {"RandomOrderReview": RandomOrderReview.RandomOrderReviewSchema, 
    #     #                 "EbisuReview": EbisuReview.EbisuReviewSchema}
...
class Card(mongo.Document):
    ...
    #     deck = fields.Nested("Deck.DeckSchema", exclude=("last_reviewed_card","currently_reviewing_card","cards"))
    #     question = fields.Nested(Fact.FactSchema())
    #     answer = fields.Nested(Fact.FactSchema())
    #     tags = fields.Nested(Tag.TagSchema, many=True)
    #     marked = fields.Bool()
    #     hidden = fields.Bool()
    #     reviews = fields.Nested(Review.ReviewSchema, many=True)
    #     last_review = fields.Nested(Review.ReviewSchema)
...
class Deck(mongo.Document):
    ...
    #     description = fields.Str()
    #     tags = fields.Nested(Tag.TagSchema, many=True)
    #     last_reviewed_card = fields.Nested(Card.CardSchema)
    #     currently_reviewing_card = fields.Nested(Card.CardSchema)
    #     cards = fields.Nested(Card.CardSchema, many=True)
