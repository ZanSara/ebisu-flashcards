...
class EbisuReview(Review):
    ...
    # class EbisuReviewSchema(Review.ReviewSchema):
    #     alpha = fields.Float()
    #     beta = fields.Float()
    #     t = fields.Float()
...
class EbisuCard(Card):
    ...
    # class EbisuCardSchema(Card.CardSchema):
    #     reviews = fields.Nested(EbisuReview.EbisuReviewSchema, many=True)
    #     last_review = fields.Nested(EbisuReview.EbisuReviewSchema)
    #     extra_info = fields.Raw()

    #     @post_load
    #     def make_ebisu_card(self, data, **kwargs):
    #         return EbisuCard(**data)
...
class EbisuDeck(Deck):
    ...
    #     last_reviewed_card = fields.Nested(EbisuCard.EbisuCardSchema)
    #     currently_reviewing_card = fields.Nested(EbisuCard.EbisuCardSchema)
    #     cards = fields.Nested(EbisuCard.EbisuCardSchema, many=True)

    #     @post_load
    #     def make_ebisu_deck(self, data, **kwargs):
    #         return EbisuDeck(**data)
