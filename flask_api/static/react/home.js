        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'a',
                _defineProperty({ href: "edit/decks/" + this.props.deck._id.$oid, className: 'dropdown-item btn' }, 'href', '#'),
                'Edit Deck'
              ),
              React.createElement(
                'a',
                _defineProperty({ href: "edit/decks/" + this.props.deck._id.$oid + "/cards", className: 'dropdown-item btn' }, 'href', '#'),
                'Cards List'
              )
            )
          ),
